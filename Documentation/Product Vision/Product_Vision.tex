...
\newpage
	 ...
	 \input{./tex/1.GameDescription.tex}
	 \section{Context}
	 \input{./tex/2.Context.tex}
	 \section{Target customer}
	 \input{./tex/3.TargetCustomer.tex}
	 \section{Customer needs}
	 \input{./tex/4.CustomerNeeds.tex}
	 \section{Essential elements} 
	 \input{./tex/5.EssentialElements.tex}
	 \section{Primary dfferentiation} 
	 \input{./tex/6.PrimaryDifferentiation.tex}
	 \section{Timeframe and budget} % (fold)
	 \input{./tex/7.TimeframeBudget.tex}
	 \section*{References}
	 \input{./tex/8.References.tex}
