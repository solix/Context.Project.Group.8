...
public class NavigatorScreen extends ViewObserver {
	...
	private TaxiIndicator indicator;
	...
	public void show() {
		...
		indicator = new TaxiIndicator(10.0f);
	}
	...
	public void render(float delta) {
		...
		// Draw the sprites
		// drawSprites();
		indicator.render(spriteBatch);
	}

	/**
	 * Can this be deleted?? This method applies the provided sprites to their
	 * objects.
	 */
	...
	public void updateTaxiLocation(int x, int y) {
