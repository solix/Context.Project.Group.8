...
public class Spawner {
	...
	/**
	 * Spawns a random PowerUp at a random location on the map.
	 * 
	 * @param world
	 *            : the world in which the powerUp is spawned
	 * @return
	 */
	...
	/**
	 * Spawns a specific powerUp at specific location.
	 * 
	 * @param spawnId
	 *            : the id of the spawnpoint on which the PowerUp is spawned.
	 * @param behaviourId
	 *            : the id of the behaviour of the powerUp.
	 * @param powerUpId
	 *            : the ID that will be assigned to the powerUp.
	 * @param world
	 *            : the world in which the powerUp is spawned
	 * @return
	 */
	...
	/**
	 * Spawns a new powerUp that is not in the world, but has to be assigned to a team.
	 * 
	 * @param behaviourId
	 *            : the id of the behavior of the powerUp.
	 * @param world
	 *            : the world in which the powerUp is spawned
	 * @return
	 */
	 ...
	 * 
	 * @param world
	 *            : the world into which the entities are spawned
	 */
	private void removeDespawnedEntityBodies(World world) {
	...
	/**
	 * Initializes the bodies of new spawned entities.
	 * 
	 * @param world
	 *            : the world into which the entities are spawned
	 */
	private void addEntityBodies(World world) {
	...
	/**
	 * Initializes newly spawned entity bodies and removes despawned entity
	 * bodies.
	 * 
	 * @param world
	 *            : the world into which the entities are spawned
