...
/**
 * Spawnpoints are attributes for the Spawner which saves the location angle and
 * say if it's active or not.
 * 
...
public class SpawnPoint {
    ...
    /**
     * Initializes a new SpawnPosition with location (x,y) and with spawning
     * angle as specified.
     * 
     * @param x
     *            : the x-position of the SpawnPoint
     * @param y
     *            : the y-position of the SpawnPoint
     * @param spawnAngle
     *            : the spawning angle in degrees
     */
