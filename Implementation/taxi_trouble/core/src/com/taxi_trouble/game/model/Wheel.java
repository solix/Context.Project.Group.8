...
public class Wheel {
     ...
     * 
     * @param world : the world for which the body should be created
     * @param position : the (relative) position to the taxi
     */
    ...
    private void createFixture() {
        ...
        //Indicate that the wheel does not participate in collision calculations
