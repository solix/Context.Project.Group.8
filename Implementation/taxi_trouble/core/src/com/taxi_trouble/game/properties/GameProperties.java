...
public final class GameProperties {
	...
	/**Retrieves the screen-width of the device that is 
    ...
    /**Retrieves the screen-height of the device that is 
     * used to play the game.
     * 
    ...
    private static PowerUpAnimation getInvincibleAnimation() {
        PowerUpAnimation animation = new PowerUpAnimation(new Texture(
               Gdx.files.internal("sprites/powerups/invincible-spritesheet.png")));
		return animation;
	}
